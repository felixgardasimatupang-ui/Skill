...
description: Mendeteksi anomali, pola error server, dan melacak trace ID dari frontend ke backend.
...
- ✅ WAJIB correlasi dengan deployment timeline (apakah error mulai setelah deploy?)
</critical_constraints>
